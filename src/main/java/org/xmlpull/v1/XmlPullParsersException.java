 ...
 */
public class XmlPullParsersException extends Exception{
    ...
    public XmlPullParsersException(String s) {
        super(s);
    }
    ...
    */
    ...
    public XmlPullParsersException(String msg, XmlPullParsers parser, Throwable chain) {
        super ((msg == null ? "" : msg+" ")
