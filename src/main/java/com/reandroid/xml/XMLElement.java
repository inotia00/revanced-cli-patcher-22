...
public class XMLElement extends XMLNodeTree implements Element<XMLNode> {
    ...
    @Override
    void endSerialize(XmlSerializers serializer) throws IOException {
    ...
    public void parse(XmlPullParsers parser) throws XmlPullParsersException, IOException {
        ...
        if(event != XmlPullParsers.START_TAG){
            throw new XmlPullParsersException("Not START_TAG event");
        }
        ...
        if(parser.getEventType() == XmlPullParsers.END_TAG){
            parser.next();
        }
    }
    ...
    public void parseAttributes(XmlPullParsers parser){
        boolean processNamespaces = parser.getFeature(XmlPullParsers.FEATURE_PROCESS_NAMESPACES);
    ...
    public static XMLElement parseElement(XmlPullParsers parser) throws IOException, XmlPullParsersException {
