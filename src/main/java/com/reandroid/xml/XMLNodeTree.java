...
public abstract class XMLNodeTree extends XMLNode implements
    ...
    abstract void startSerialize(XmlSerializers serializer) throws IOException;
    private void serializeChildes(XmlSerializers serializer) throws IOException {
        Iterator<XMLNode> itr = iterator();
        while (itr.hasNext()){
            itr.next().serialize(serializer);
        }
    }
    abstract void endSerialize(XmlSerializers serializer) throws IOException;
