...
public class StyleDocument extends XMLDocument implements
    ...
    public void parseString(String xmlString) throws XmlPullParsersException, IOException {
        xmlString = "<parser>" + xmlString + "</parser>";
        XmlPullParsers parser = PARSER;
    ...
    public static StyleDocument parseNext(XmlPullParsers parser) throws IOException, XmlPullParsersException {
    ...
    public static StyleDocument parseStyledString(String xmlStyledString) throws XmlPullParsersException, IOException {
        StyleDocument styleDocument = new StyleDocument();
        styleDocument.parseString(xmlStyledString);
        return styleDocument;
    }

    private static final XmlPullParsers PARSER = XMLFactory.newPullParser();
}
