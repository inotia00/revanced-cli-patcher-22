...
public class DocumentSerializers implements XmlSerializers {
    ...
    public DocumentSerializers(XMLDocument document){
    ...
    @Override
    public XmlSerializers startTag(String namespace, String name) throws IOException {
        this.currentText = null;
    ...
    @Override
    public XmlSerializers attribute(String namespace, String name, String value) throws IOException{
    ...
    @Override
    public XmlSerializers endTag(String namespace, String name) throws IOException{
    ...
    @Override
    public XmlSerializers text(String text) throws IOException{
        appendText(text);
        return this;
    }
