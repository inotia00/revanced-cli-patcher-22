...
public class XmlSerializersWrapper implements XmlSerializers {

    private final XmlSerializers baseSerializer;

    public XmlSerializersWrapper(XmlSerializers baseSerializer) {
        this.baseSerializer = baseSerializer;
    }

    public XmlSerializers getBaseSerializer() {
    ...
    @Override
    public XmlSerializers attribute(String namespace, String name, String value) throws IOException, IllegalArgumentException, IllegalStateException {
        return getBaseSerializer().attribute(namespace, name, value);
    }
    @Override
    public XmlSerializers endTag(String namespace, String name) throws IOException, IllegalArgumentException, IllegalStateException {
        return getBaseSerializer().endTag(namespace, name);
    }
    @Override
    public XmlSerializers text(String text) throws IOException, IllegalArgumentException, IllegalStateException {
        return getBaseSerializer().text(text);
    }
    @Override
    public XmlSerializers text(char[] buf, int start, int len) throws IOException, IllegalArgumentException, IllegalStateException {
