...
public class TableIdentifier{
    ...
    public PackageIdentifier loadPublicXml(File file) throws IOException, XmlPullParsersException {
        PackageIdentifier packageIdentifier = new PackageIdentifier();
    ...
    public PackageIdentifier loadPublicXml(InputStream inputStream) throws IOException, XmlPullParsersException {
        PackageIdentifier packageIdentifier = new PackageIdentifier();
        packageIdentifier.loadPublicXml(inputStream);
        add(packageIdentifier);
        return packageIdentifier;
    }
    public PackageIdentifier loadPublicXml(Reader reader) throws IOException, XmlPullParsersException {PackageIdentifier packageIdentifier = new PackageIdentifier();
        packageIdentifier.loadPublicXml(reader);
        add(packageIdentifier);
        return packageIdentifier;
    }
    public PackageIdentifier loadPublicXml(XmlPullParsers parser) throws IOException, XmlPullParsersException {
        PackageIdentifier packageIdentifier = new PackageIdentifier();
