...
public class ValuesDirectorySerializer implements ValuesSerializerFactory{
    ...
    private final Map<XmlSerializers, File> serializerFileMap;
    public ValuesDirectorySerializer(File resourcesDir){
        this.resourcesDir = resourcesDir;
        this.serializerFileMap = new HashMap<>();
    }
    @Override
    public void onFinish(XmlSerializers serializer, int writtenEntries) throws IOException {
    ...
    @Override
    public XmlSerializers createSerializer(TypeBlock typeBlock) throws IOException {
