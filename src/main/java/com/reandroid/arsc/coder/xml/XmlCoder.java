...
public class XmlCoder {
    ...
    public static class ValuesXml {
        ...
        public void decodePackage(ValuesSerializerFactory serializerFactory,
            ...
            for (SpecTypePair specTypePair : specs){
                ...
                for(ResConfig resConfig : configs){
                    ...
                    XmlSerializers serializer = serializerFactory.createSerializer(typeBlock);
        ...
        public int decode(XmlSerializers serializer,
        ...
        public boolean decode(XmlSerializers serializer,
        ...
        private void decodeBag(XmlSerializers serializer, Entry entry) throws IOException {
        ...
        private void decodeScalar(XmlSerializers serializer, Entry entry) throws IOException {
            String tag = startEntry(serializer, entry);
        ...
        private String startEntry(XmlSerializers serializer, Entry entry) throws IOException {
        ...
        private void endEntry(XmlSerializers serializer, String tag) throws IOException {
            endEntry(serializer, tag, false);
        }
        private void endEntry(XmlSerializers serializer, String tag, boolean indent) throws IOException {
            if(indent){
                XmlDecodeUtil.entryIndent(serializer);
            }
        ...
        public void encode(File valuesXmlFile, PackageBlock packageBlock) throws IOException, XmlPullParsersException {
            XmlPullParsers parser = XMLFactory.newPullParser(valuesXmlFile);
        ...
        public void encode(XmlPullParsers parser, TypeBlock typeBlock) throws IOException, XmlPullParsersException {
            int event = parser.getEventType();
            boolean documentStarted = false;
            if(event == XmlPullParsers.START_DOCUMENT){
            ...
            while (XMLUtil.ensureStartTag(parser) == XmlPullParsers.START_TAG){
    ...
    public static class BagChild {
        ...
        public int decode(XmlSerializers serializer, Entry entry) throws IOException{
        ...
        public int decodeAttr(XmlSerializers serializer, Entry entry) throws IOException {
        ...
        public int decodePlural(XmlSerializers serializer, Entry entry) throws IOException {
            ResTableMapEntry mapEntry = entry.getResTableMapEntry();
        ...
        public int decodeStyle(XmlSerializers serializer, Entry entry) throws IOException {
            ResTableMapEntry mapEntry = entry.getResTableMapEntry();
            ResValueMapArray mapArray = mapEntry.getValue();
            int childCount = 0;
            Iterator<ResValueMap> iterator = mapArray.iterator();
        ...
        public int decodeArray(XmlSerializers serializer, Entry entry) throws IOException {
        ...
        private void startTag(XmlSerializers serializer, String name) throws IOException {
            XmlDecodeUtil.bagIndent(serializer);
            serializer.startTag(null, name);
        }
        private void endTag(XmlSerializers serializer, String name) throws IOException {
    ...
    public static class BagRootAttribute {
        public void decode(XmlSerializers serializer, Entry entry) throws IOException {
            decodeParent(serializer, entry);
            decodeAttrTypes(serializer, entry);
        }
        public void decodeAttrTypes(XmlSerializers serializer, Entry entry) throws IOException {
        ...
        public void decodeParent(XmlSerializers serializer, Entry entry) throws IOException {
            ResTableMapEntry mapEntry = entry.getResTableMapEntry();
