...
public class ResourceTable implements Iterable<ResourcePackage> {
    ...
    public XmlResourceParsers getLayout(int resourceId) throws IOException {
        return getParser(resourceId);
    }
    public XmlResourceParsers getXml(int resourceId) throws IOException {
        return getParser(resourceId);
    }
    public XmlResourceParsers getParser(int resourceId) throws IOException {
    ...
    public Iterator<XmlResourceParsers> getParsers(int resourceId) {
    ...
    XmlResourceParsers loadXml(String path) throws IOException {
        ApkFile apkFile = getApkFile();
