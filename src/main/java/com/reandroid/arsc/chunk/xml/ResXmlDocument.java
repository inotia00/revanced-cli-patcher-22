...
public class ResXmlDocument extends Chunk<HeaderBlock>
    ...
    private boolean parseNext(XmlPullParsers parser) throws IOException, XmlPullParsersException {
        int event = parser.getEventType();
        while (event != XmlPullParsers.START_TAG && event != XmlPullParsers.END_DOCUMENT){
            event = parser.next();
        }
    ...
    public String serializeToXml() throws IOException {
        ...
        XmlSerializers serializer = XMLFactory.newSerializer(writer);
    ...
    public void serialize(XmlSerializers serializer) throws IOException {
