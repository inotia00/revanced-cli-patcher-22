...
public class ResXmlPullParser implements XmlResourceParsers {
    ...
    public void setFeature(String name, boolean state) throws XmlPullParsersException {
        ...
        if(FEATURE_PROCESS_NAMESPACES.equals(name)) {
            ...
            throw new XmlPullParsersException("Unsupported feature: " + name);
        }
        if(changed && mIsTagStared){
            throw new XmlPullParsersException("Feature changed during parsing: "
                    + name + ", state=" + state);
        }
    }
    ...
    @Override
    public void setProperty(String name, Object value) throws XmlPullParsersException {
    }
    @Override
    ...
    @Override
    public void setInput(Reader in) throws XmlPullParsersException {
        InputStream inputStream = getFromLock(in);
        if(inputStream == null){
            throw new XmlPullParsersException("Can't parse binary xml from reader");
        }
        setInput(inputStream, null);
    }
    @Override
    public void setInput(InputStream inputStream, String inputEncoding) throws XmlPullParsersException {
    ...
    @Override
    public void defineEntityReplacementText(String entityName, String replacementText) throws XmlPullParsersException {
    }
    @Override
    public int getNamespaceCount(int depth) throws XmlPullParsersException {
        if(isCountNamespacesAsAttribute()){
            return 0;
        }
        ResXmlElement element = getCurrentElement();
    ...
    @Override
    public String getNamespacePrefix(int pos) throws XmlPullParsersException {
        ResXmlElement element = getCurrentElement();
        if(element!=null){
    ...
    @Override
    public String getNamespaceUri(int pos) throws XmlPullParsersException {
        ResXmlElement element = getCurrentElement();
        if(element!=null){
    ...
    @Override
    public void require(int type, String namespace, String name) throws XmlPullParsersException, IOException {
    ...
    private void loadResXmlDocument(InputStream inputStream) throws XmlPullParsersException {
        synchronized (this){
            ...
            try {
                ...
                XmlPullParsersException pullParserException = new XmlPullParsersException(exception.getMessage());
