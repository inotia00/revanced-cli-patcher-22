...
public abstract class ResXmlNode extends FixedBlockContainer  implements JSONConvert<JSONObject> {
    ...
    public abstract void serialize(XmlSerializers serializer, boolean decode) throws IOException;
    public abstract void parse(XmlPullParsers parser) throws IOException, XmlPullParsersException;
