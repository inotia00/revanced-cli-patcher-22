...
public class ResXmlPullSerializers implements XmlSerializers {
    ...
    @Override
    public ResXmlPullSerializers startTag(String namespace, String name) throws IOException, IllegalArgumentException, IllegalStateException {
        flushText();
        ResXmlElement element = getCurrentElement();
        String prefix = null;
        int i = name.indexOf(':');
    ...
    @Override
    public ResXmlPullSerializers attribute(String namespace, String name, String value) throws IOException, IllegalArgumentException, IllegalStateException {
        ResXmlElement element = mCurrentElement;
        String prefix = null;
        int i = name.indexOf(':');
        if(i > 0){
    ...
    @Override
    public ResXmlPullSerializers endTag(String namespace, String name) throws IOException, IllegalArgumentException, IllegalStateException {
        flushText();
    ...
    @Override
    public ResXmlPullSerializers text(String text) throws IOException, IllegalArgumentException, IllegalStateException {
        appendText(text);
        return this;
    }

    @Override
    public ResXmlPullSerializers text(char[] buf, int start, int len) throws IOException, IllegalArgumentException, IllegalStateException {
