...
public class PackageBlock extends Chunk<PackageHeader>
    ...
    public void serializePublicXml(XmlSerializers serializer) throws IOException {
        serializePublicXml(serializer, true);
    }
    public void serializePublicXml(XmlSerializers serializer, boolean fullDocument) throws IOException {
        if(fullDocument){
    ...
    private void serializePublicXmlTypes(XmlSerializers serializer) throws IOException {
        Iterator<SpecTypePair> iterator = getSpecTypePairs();
        while (iterator.hasNext()){
    ...
    public void parsePublicXml(XmlPullParsers parser) throws IOException,
            XmlPullParsersException {
        getPublicXmlParser()
                .parse(parser);
    }
    ...
    public static class PublicXmlParser{
        ...
        public PublicXmlParser parse(XmlPullParsers parser) throws IOException, XmlPullParsersException {
        ...
        private void parseElements(XmlPullParsers parser) throws IOException, XmlPullParsersException {
        ...
        private void parseResourcesAttributes(XmlPullParsers parser) throws IOException, XmlPullParsersException {
