...
public class Overlayable extends Chunk<OverlayableHeader> implements
    ...
    public void parse(XmlPullParsers parser) throws IOException, XmlPullParsersException {
        ...
        if (!TAG_overlayable.equals(parser.getName())) {
            throw new XmlPullParsersException("Expecting tag '" + TAG_overlayable +
        ...
        while (parser.getEventType() != XmlPullParsers.END_TAG && parser.getEventType() != XmlPullParsers.END_DOCUMENT) {
