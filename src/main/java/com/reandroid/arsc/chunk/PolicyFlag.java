...
public class PolicyFlag {
    ...
    public static int parse(XmlPullParsers parser) throws IOException {
    ...
    public static void serialize(XmlSerializers serializer, int policyFlags) throws IOException {
