...
public class TableStringPool extends StringPool<TableString> {
    ...
    public TableString getOrCreateStyled(String xmlString) throws IOException, XmlPullParsersException {
        return getOrCreate(StyleDocument.parseStyledString(xmlString));
    }
    public TableString getOrCreate(XmlPullParsers parser) throws IOException, XmlPullParsersException {
