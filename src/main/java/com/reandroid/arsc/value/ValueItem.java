...
public abstract class ValueItem extends BlockItem implements Value,
    ...
    public void serializeText(XmlSerializers serializer) throws IOException {
        serializeText(serializer, false);
    }
    public void serializeText(XmlSerializers serializer, boolean escapeValues) throws IOException {
        if(getValueType() == ValueType.STRING){
            StringItem stringItem = getDataAsPoolString();
            if(stringItem != null){
    ...
    public void serializeAttribute(XmlSerializers serializer, String name, boolean ignore_empty) throws IOException {
        serializeAttribute(serializer, null, name, ignore_empty);
    }
    public void serializeAttribute(XmlSerializers serializer, String namespace, String name, boolean ignore_empty) throws IOException {
        if(getValueType() == ValueType.STRING){
            StringItem stringItem = getDataAsPoolString();
            if(stringItem != null){
