...
public class XMLTableBlockEncoder {
    ...
    private void scanResourceFiles(File resourcesDirectory) throws IOException, XmlPullParsersException {
    ...
    private void loadPublicXmlFile(File pubXmlFile) throws IOException {
        try {
            XmlPullParsers parser = XMLFactory.newPullParser(pubXmlFile);
    ...
    private void encodeValues(List<File> pubXmlFileList) throws IOException, XmlPullParsersException {
    ...
    private void encodeAttrs(List<File> pubXmlFileList) throws IOException, XmlPullParsersException {
    ...
    private void encodeResDir(File resDir) throws IOException, XmlPullParsersException {
    ...
    private void preloadStyledStrings(File resDir) throws IOException, XmlPullParsersException {
    ...
    private void preloadStyledStringsXml(File file) throws IOException, XmlPullParsersException {
    ...
    private void encodeValuesDir(File valuesDir) throws IOException, XmlPullParsersException {
    ...
    private void encodeNonTypeValues(List<File> pubXmlFileList) throws IOException, XmlPullParsersException {
    ...
    private void encodeNonTypeValue(File file) throws IOException, XmlPullParsersException {
        if (isAlreadyParsed(file)) {
            return;
        }
        addParsedFiles(file);
    ...
    private void encodeOverlayable(File file) throws IOException, XmlPullParsersException {
